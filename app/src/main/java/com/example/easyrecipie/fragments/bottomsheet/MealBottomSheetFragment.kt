package com.example.easyrecipie.fragments.bottomsheet
...
import com.example.easyrecipie.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun observeBottomSheetMeal() {
        viewModel.observeGetMealsByIdLiveData().observe(viewLifecycleOwner, Observer { meal->
            Glide.with(this)
